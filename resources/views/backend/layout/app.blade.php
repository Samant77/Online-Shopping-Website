...
<link rel="stylesheet" href="{{asset('public/backend/assets/plugins/summernote/summernote.min.css')}}">
...
<img src="{{ asset('storage/images' . Auth::user()->imagePath) }}" class='img-circle elevation-2' width="40" height="40" alt="">
</a>
<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3">
<h4 class="h4 mb-0"><strong>{{Auth::user()->frist}} {{Auth::user()->last}}</strong></h4>
...
<!-- Summernote -->
<script src="{{asset('public/backend/assets/plugins/summernote/summernote.min.js')}}"></script>


<script src="{{asset('public/backend/assets/plugins/select2/js/select2.min.js')}}"></script>

<script src="{{asset('public/backend/assets/plugins/dropzone/dropzone.js')}}"></script>
